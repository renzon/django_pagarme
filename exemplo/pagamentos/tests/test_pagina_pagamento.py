...
from django_pagarme.models import PaymentItem, PaymentConfig


@pytest.fixture
def payment_config(db):
    return baker.make(PaymentConfig)


@pytest.fixture
def payment_item(payment_config):
    return baker.make(PaymentItem, default_config=payment_config)
...
def test_status_code(payment_item: PaymentItem, resp):
